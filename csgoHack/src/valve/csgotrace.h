...
struct Ray_t
{
    ...
    void Init(SDKVec3 const& start, SDKVec3 const& end)
    {
        m_Delta = end - start;
    ...
    void Init(SDKVec3 const& start, SDKVec3 const& end, SDKVec3 const& mins, SDKVec3 const& maxs)
    {
        m_Delta = end - start;
...
public:
    ...
    SDKVec3         startpos;            // start position
    SDKVec3         endpos;              // final position
